let elements = (() => {
  ...
  let elements = {}
  for (let i = 0; i < dumbelements.length; i++) {
    elements[dumbelements[i].symbol.toLowerCase()] = dumbelements[i]
  }
  return elements
})()
